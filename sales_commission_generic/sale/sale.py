...
class SaleOrder(models.Model):
    ...
    commission_ids = fields.One2many('invoice.sale.commission','order_id', string='Sales Commissions', groups='sales_commission_generic.group_sales_commission_manager',
    ...
    def get_exceptions(self, commission_brw):
        ...
        for exception in commission_brw.exception_ids:
            product_exception_id = exception.search([
            ...
            subcateg_exception_id = exception.search([
                                           ('commission_id', '=', commission_brw.id),
            ...
            exclusive_categ_exception_id = exception.search([
                                           ('commission_id', '=', commission_brw.id),
